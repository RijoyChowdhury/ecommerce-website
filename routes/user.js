...
// get user by id
router.get('/:userId', checkUserDataPresent, getUserByIdHandler);
// create user
router.post('/', checkRequestBody, createUserHandler);
// update user details by userId
router.post('/:userId', checkRequestBody, checkUserDataPresent, updateUserByIdHandler);
// delete user by Id
router.delete('/:userId', checkUserDataPresent, deleteUserByIdHandler);
